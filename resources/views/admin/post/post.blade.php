		...
		<div class="box box-primary">
		  ...
		  <div class="col-lg-6">
		      <div class="form-group">
		        ...
		        <input type="text" class="form-control" id="title" name="title" placeholder="Title for post">
		      </div>
		      <div class="form-group">
		        <label for="subtitle">Subtitle</label>
		        <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Subtitle for post">
		      </div>
		      <div class="form-group">
	  ...
	  <section class="content">
	    <div class="row">
	      ...
	      <!-- /.col-->
		        ...
		        <label>
		          <input type="checkbox" name="status" value="1"> Check to publish
		        </label>
		      </div>
	    </div>
	    <!-- ./row -->
